...
import { LayoutDashboard, Building2, ClipboardCheck, User as UserIcon, LogOut } from "lucide-react";
        ...
        <div className="flex h-full flex-col">
          <div className="flex items-center justify-center border-b border-stone-200 py-6">
            <div className="text-center">
              ...
              <h2 className="mt-3 font-medium text-ink">{user?.username || "Agent"}</h2>
              <p className="text-xs text-stone-500">Verified Agent</p>
            </div>
          </div>
